...
namespace BLL.Services
{
    public class UserAuthService: IUserAuthService
    {
        ...
        public UserAuthService(UserManager<AppUser> userManager, RoleManager<IdentityRole> roleManager, IConfiguration configuration, SignInManager<AppUser> signInManager, ITokenService tokenService)
        {
        ...
        public async Task<List<UserDetailDto>> GetAllUserDetailsAsync()
        {
